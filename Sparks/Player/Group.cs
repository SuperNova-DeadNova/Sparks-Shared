    ...
    public sealed class Group
    {
        ...
        public static void LoadAll() {
            ...
            if (File.Exists(Paths.RankPropsFile)) {
                ...
                Add(LevelPermission.Sparkie, 134217728, 21024000, "&6S&ep&6a&er&6k&ei&6e", "&6", GEN_ADMIN, 512); // 512^3
            ...
            if (GoldenRank == null)
                Add(LevelPermission.Sparkie, 134217728, 21024000, "&6S&ep&6a&er&6k&ei&6e", "&6", GEN_ADMIN, 512);
        ...
        static void AddGroup(Group temp) {
            ...
            } else if (temp.Permission > LevelPermission.Null) { // also handles LevelPermission.Null
