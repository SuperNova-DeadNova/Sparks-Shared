    ...
    public sealed partial class Group {
        ...
        public static void LoadAll() {
            ...
            if (File.Exists(Paths.RankPropsFile)) {
                ...
                Register(new Group(LevelPermission.Sparkie, int.MaxValue, int.MaxValue, "&6S&ep&6a&er&6k&ei&6e", '6'));
            ...
            if (NobodyRank == null)
                Register(new Group(LevelPermission.Nobody, int.MaxValue, int.MaxValue, "Nobody", '0'));
            if (GoldenRank == null)
                Register(new Group(LevelPermission.Sparkie, int.MaxValue, int.MaxValue, "&6S&ep&6a&er&6k&ei&6e", '6'));
            ...
            reloading = true;
            SaveAll(GroupList);
            Player.Sparks.group = GoldenRank;
