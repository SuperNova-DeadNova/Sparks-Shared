...
{
    public abstract class BotControllersCmd1 : Command2 
    {
        public override string type { get { return CommandTypes.Moderation; } }
        public override LevelPermission defaultRank { get { return LevelPermission.Admin; } }
        public abstract RelayBot1 Bot { get; }
                ...
                case "rank":
                    if (arg.Length == 0) {
                        p.Message("{0} controllers have the rank {1}", bot.RelayName,
                                  Group.GetColoredName(Server.Config.IRCControllerRank1));
                        return;
                    }
                    
                    Group grp = Matcher.FindRanks(p, arg);
                    if (grp == null) return;
                    if (Server.Config.IRCControllerRank1 > data.Rank) {
                    ...
                    Server.Config.IRCControllerRank1 = grp.Permission;
                    SrvProperties.Save();
