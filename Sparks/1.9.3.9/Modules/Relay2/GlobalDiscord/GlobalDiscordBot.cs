...
{
    public sealed class GlobalDiscordBot : RelayBot2
    {
        ...
        void PrintAttachments(JsonObject data, string channel)
        {
            ...
            if (list == null) return;
            RelayUser2 user = ExtractUser(data);
        ...
        public override void MessagePlayers(RelayPlayer2 p)
        {
