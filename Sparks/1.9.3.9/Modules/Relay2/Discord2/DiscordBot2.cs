...
{
    public sealed class DiscordBot2 : RelayBot2
    {
        DiscordApiClient2 api;
        DiscordWebsocket2 socket;
        DiscordSession2 session;
        string botUserID;
        ...
        public override string RelayName { get { return "Discord2"; } }
        public override bool Enabled { get { return Config.Enabled; } }
        public override string UserID { get { return botUserID; } }
        public Discord2Config Config;

        TextFile replacementsFile = new TextFile("text/discord/replacements2.txt",
        ...
        {
            Controllers = PlayerList.Load("text/discord/controllers2.txt");
        }
        ...
        public void Send(DiscordApiMessage2 msg)
        {
