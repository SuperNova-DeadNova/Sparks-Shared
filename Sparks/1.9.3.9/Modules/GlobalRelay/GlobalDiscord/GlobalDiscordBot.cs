...
namespace GoldenSparks.Modules.GlobalRelay.GlobalDiscord
{
    public sealed class GlobalDiscordBot : GlobalRelayBot
    {
        GlobalDiscordApiClient api;
        GlobalDiscordWebsocket socket;
        GlobalDiscordSession session;
        string botUserID;
        ...
        public override string RelayName { get { return "GlobalDiscord"; } }
        public override bool Enabled { get { return Config.Enabled; } }
        public override string UserID { get { return botUserID; } }
        public GlobalDiscordConfig Config;

        TextFile replacementsFile = new TextFile("globalchat/discordreplacements.txt",
                                        "// This file is used to replace words/phrases sent to GlobalDiscord",
        ...
        {
            socket = new GlobalDiscordWebsocket();
        ...
        {
            Controllers = PlayerList.Load("globalchat/discordcontrollers.txt");
        }
        ...
        void HandleResumedEvent(JsonObject data)
        {
            ...
            if (api == null)
            {
                api = new GlobalDiscordApiClient();
        ...
        void PrintAttachments(JsonObject data, string channel)
        {
            ...
            if (list == null) return;
            GlobalRelayUser user = ExtractUser(data);
        ...
        {
            session = new GlobalDiscordSession();
            base.OnStart();
        ...
        public void Send(GlobalDiscordApiMessage msg)
        {
        ...
        public override void MessagePlayers(GlobalRelayPlayer p)
        {
