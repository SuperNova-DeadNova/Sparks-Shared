...
namespace GoldenSparks.Modules.GlobalRelay.GlobalDiscord
{
    public sealed class GlobalDiscordConfig 
    {
        ...
        const string PROPS_PATH = "globalchat/globaldiscordbot.properties";
        ...
        public void Load() {
            ...
            if (cfg == null) cfg = ConfigElement.GetAll(typeof(GlobalDiscordConfig));
    ...
    public sealed class GlobalDiscordPlugin : Plugin 
    {
        ...
        public override void Unload(bool shutdown) {
            ...
            Bot.Disconnect("Disconnecting GlobalDiscord bot");
        }
        
        void OnConfigUpdated() { Bot.ReloadConfig(); }
    }
    
    public sealed class CmdGlobalChatBot : GlobalRelayBotCmd 
    {
        public override string name { get { return "GlobalDiscordBot"; } }
        public override GlobalRelayBot Bot { get { return GlobalDiscordPlugin.Bot; } }
    }
    
    public sealed class CmdGlobalChatControllers : GlobalBotControllersCmd 
    {
        public override string name { get { return "GlobalDiscordControllers"; } }
        public override GlobalRelayBot Bot { get { return GlobalDiscordPlugin.Bot; } }
    }
}
