...
{   
    public sealed class GlobalIRCPlugin : Plugin 
    {
        ...
        public override void Unload(bool shutdown) {
            ...
            Bot.Disconnect("Disconnecting GlobalIRC bot");
        }
        
        void OnConfigUpdated() { Bot.ReloadConfig(); }
    }
    
    public sealed class CmdGlobalIRCBot : GlobalRelayBotCmd 
    {
    ...
    public sealed class CmdGlobalIrcControllers : GlobalBotControllersCmd 
    {
        public override string name { get { return "GlobalIRCControllers"; } }
