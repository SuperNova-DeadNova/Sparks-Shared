...
namespace GoldenSparks 
{
    public partial class Player : IDisposable
    {
        ...
        public void Message2(string message) { Message2(0, message); }

        public virtual void Message2(byte type, string message)
        {
            ...
            try
            {
                message = LineWrapper.CleanupColors(message, true, true);
