...
namespace SuperNova.Modules.Relay2.GlobalDiscord
{
    ...
    public sealed class CmdGlobalChatBot : RelayBotCmd2 
    {
        public override string name { get { return "GlobalDiscordBot"; } }
        public override RelayBot2 Bot { get { return GlobalDiscordPlugin.Bot; } }
    }
    
    public sealed class CmdGlobalChatControllers : BotControllersCmd2 
    {
