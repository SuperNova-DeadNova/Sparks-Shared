...
namespace GoldenSparks.Modules.Relay2 
{
    public abstract class BotControllersCmd2 : Command2 
    {
        public override string type { get { return CommandTypes.Moderation; } }
        public override LevelPermission defaultRank { get { return LevelPermission.Admin; } }
        public abstract RelayBot2 Bot { get; }
                ...
                case "rank":
                    if (arg.Length == 0) {
                        p.Message("{0} controllers have the rank {1}", bot.RelayName,
                                  Group.GetColoredName(Server.Config.IRCControllerRank2));
                        return;
                    }
                    
                    Group grp = Matcher.FindRanks(p, arg);
                    if (grp == null) return;
                    if (Server.Config.IRCControllerRank2 > data.Rank) {
                    ...
                    Server.Config.IRCControllerRank2 = grp.Permission;
                    SrvProperties.Save();
