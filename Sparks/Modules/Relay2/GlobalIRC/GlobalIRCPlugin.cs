...
{   
    ...
    public sealed class CmdGlobalIRCBot : RelayBotCmd2 
    {
        ...
        public override RelayBot2 Bot { get { return GlobalIRCPlugin.Bot; } }
    }
    
    public sealed class CmdGlobalIrcControllers : BotControllersCmd2 
    {
