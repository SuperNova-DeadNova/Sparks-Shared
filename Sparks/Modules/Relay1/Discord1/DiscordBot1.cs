...
{
    public sealed class DiscordBot1 : RelayBot1 
    {
        DiscordApiClient1 api;
        DiscordWebsocket1 socket;
        DiscordSession1 session;
        string botUserID;
        ...
        public override string RelayName { get { return "Discord1"; } }
        public override bool Enabled     { get { return Config.Enabled; } }
        public override string UserID    { get { return botUserID; } }
        public Discord1Config Config;
        
        TextFile replacementsFile = new TextFile("text/discord/replacements1.txt",
        ...
        public override void LoadControllers() {
            Controllers = PlayerList.Load("text/discord/controllers1.txt");
        }
        ...
        void PrintAttachments(JsonObject data, string channel) {
            ...
            if (list == null) return;
            RelayUser1 user = ExtractUser(data);
        ...
        public void Send(DiscordApiMessage1 msg) {
        ...
        // all users are already verified by Discord1
        ...
        public override void MessagePlayers(RelayPlayer1 p) {
